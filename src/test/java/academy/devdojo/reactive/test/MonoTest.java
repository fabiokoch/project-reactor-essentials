...
public class MonoTest {
    ...
    public void monoDoOnMethods() {
        ...
        Mono<Object> mono = Mono.just(name)
                ...
                .doOnNext(s -> log.info("Value is here, Executing doOnNext {}", s))//will noty be executed
...
//                .verifyComplete();
    ...
    public void monoDoOnError() {
        Mono<Object> error = Mono.error(new IllegalArgumentException("Illeggal argument exception error"))
